# Fork info
This is a repo used to release android binaries of the Dolphin fork, Prime Hack. Nothing has been changed besides the package name, so that it doesn't conflict with installations of official dolphin.

In the release section, you will find some control configurations. These were created by u/Warm_Path on reddit.
